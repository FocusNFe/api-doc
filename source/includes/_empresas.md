...
| certifico\_especifico                                      | booleano           | Não         | Não          | Não          | Se informado true, atualiza o certificado apenas para a empresa atual\. Se não informado ou false, atualiza todas as empresas com o mesmo CNPJ base (matriz e filiais)\. |
